...
$query = "SELECT * FROM furniture_product Where status = 'publish' ORDER BY id";
...
<div class="jumbotron">
  <h2 class="text-center mt-5">Sản Phẩm</h2>
</div>
  ...
  <div class="row">
    <div class="col-md-3 col-12">
      <div class="list-group">
        <a href='product.php' class='list-group-item'><i class='fal fa-home ml-2'></i> Danh Mục </a>
        <?php
        ...
        if (mysqli_num_rows($cat_run) > 0) {
          ...
          echo " <a class='list-group-item'> Không có danh mục nào! </a>";
        }
    ...
    <div class="col-md-9 col-12">
      ...
      <div class="row">
        ...
        if (isset($_GET['cat_id'])) {
          ...
          $p_query = "SELECT * FROM furniture_product WHERE category=$catid ORDER BY id DESC LIMIT $product_start,$required_pro";
        } else if (isset($_POST['sear_submit'])) {
          $search = $_POST['search'];
          $p_query = "SELECT * FROM furniture_product WHERE title LIKE '%$search%' ";
        } else {
          $p_query = "SELECT * FROM furniture_product WHERE status='publish' ORDER BY id DESC LIMIT $product_start,$required_pro";
        }
